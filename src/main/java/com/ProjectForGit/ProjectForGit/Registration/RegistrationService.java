...
import com.ProjectForGit.ProjectForGit.AppUser.AppUser;
...
import com.ProjectForGit.ProjectForGit.EmailSender.EmailSender;
...
public class RegistrationService {
    ...
    public void registerNewUser(RegistrationRequest registrationRequest){
        String token = appUserService.registerNewAppUser(
                new AppUser(
